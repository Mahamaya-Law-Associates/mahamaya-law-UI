    ...
    <div className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold inline-block px-6 py-4 rounded-md border border-gray-200">
            Our Services
          </h2>
        </div>
        ...
        <div className="mt-20 text-center"> {/* Centered and responsive */}
          ...
          <a 
          href="/contactus"
          className="text-4xl sm:text-5xl lg:text-3xl font-sans inline-block px-6 py-4 rounded-md border border-gray-200 transform hover:scale-105 transition duration-300 ease-in-out"
